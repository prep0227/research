...
Config: dt=0.02s, T=6.0s, H=18, tau_fire=0.08s, tau_vision=0.03s, tau_gimbal=0.06s, estimator=IMM(CV+CT), solver=ADMM, seeds=10, wall=418s
...
| accel | drift | 0.082 | 0.148 | 0.755 | +67.3pp p=0.000 d=+4.28 | +60.7pp p=0.000 d=+3.97 |
