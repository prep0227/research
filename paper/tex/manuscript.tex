...
accel & 0.5 & 0.457 & 0.594 & 0.978\\
accel & 1.2 & 0.358 & 0.330 & 0.901\\
accel & 2.0 & 0.082 & 0.148 & 0.755\\
\bottomrule\end{tabular}\end{table}
\begin{table}[t]\centering\small
...
accel & 0.5 & +52.1 (p<0.001) & +38.4 (p<0.001)\\
accel & 1.2 & +54.3 (p<0.001) & +57.1 (p<0.001)\\
accel & 2.0 & +67.3 (p<0.001) & +60.7 (p<0.001)\\
\bottomrule\end{tabular}\end{table}
\begin{table}[t]\centering\small
