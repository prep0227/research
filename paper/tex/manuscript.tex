...
\textbf{Status}: protocol v1.1 finalized (see `project/experiment_protocol.md`); hardware bring-up in progress (P3). This section will report:
...
\item \textbf{Offline replay}: every condition records a full-chain event log (`tools/replay/`); B0/B1/Ours are replayed on the same detection stream to isolate the control/compensation contribution.
